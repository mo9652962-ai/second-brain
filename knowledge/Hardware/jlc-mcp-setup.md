...
| 组件 | 位置 | 用途 |
|:-----|:------|:------|
| **jlcmcp MCP Server** | `%USERPROFILE%\jlcmcp\dist\index.js` | 38 个 PCB/原理图工具 |
| **relay.js** | `%USERPROFILE%\jlcmcp\relay.js` | WebSocket 中继（替代 OpenClaw gateway） |
| **jlc-bridge.eext** | `%USERPROFILE%\jlcmcp\jlc-bridge\build\` | EDA 扩展插件（已安装） |

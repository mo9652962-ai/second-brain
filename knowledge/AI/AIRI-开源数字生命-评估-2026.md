...
- [ ] B 站 AI 角色方向立项 → 部署 AIRI 试跑（Node 23+ / pnpm）→ ⏳ 需 sora 拍板方向（2026-09-13 复核仍 open）
- [ ] 墨题多模型重构 → 参考 xsai adapter 模式 → ⏳ 需专项调研（2026-09-13 复核仍 open）
- [ ] 口语音频 → 参考 webai-realtime-voice-chat → ⏳ 需专项调研（2026-09-13 复核仍 open）
- [ ] 内容选题：AI 玩游戏（Minecraft/Factorio 代理演示）→ ⏳ 内容选题待 sora 排期（2026-09-13 复核仍 open）

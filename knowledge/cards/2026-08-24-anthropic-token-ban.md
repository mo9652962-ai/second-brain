...
- [x] **Hermes 配置面收紧**：按 OWASP MCP security guide 审计已启用的 MCP server / 工具开关 → ✅ 2026-08-30 已执行：6 启用 MCP 全部本地/官方（code-review-graph/filesystem/github/jlcmcp/memvid/obsidian 均 loopback 或官方包）、jlceda 已禁用、无远程 MCP、OWASP 清单通过；唯一观察项 filesystem 根目录=%USERPROFILE% 权限面大（设计需求，知悉接受）→ 详见 suggestions-applied-2026-08-30 报告

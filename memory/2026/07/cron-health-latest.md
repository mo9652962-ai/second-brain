...
updated: 2026-09-23 12:44
---

# Cron 健康看板 — 2026-09-23 12:44

总任务数: 45

| ⚪ | AI测评周报                         | 0 8 * * 1       |  |
| ⚪ | GitHub 宝藏挖掘                    | 30 12 * * 0     |  |
| ⚪ | api-media-weekly-probe         | 15 10 * * 1     |  |
| ⚪ | arxiv-fetch                    | 30 6 * * *      |  |
| ⚪ | arxiv-summarize                | 0 13 * * 0      |  |
| ⚪ | biweekly-skill-audit           | 30 12 1,15 * *  |  |
| ⚪ | cache-hit-monitor              | 0 23 * * *      |  |
| ⚪ | cron-alert-watchdog            | 30 6 * * *      |  |
| ⚪ | cron-health-board              | 0 */4 * * *     |  |
| ⚪ | daily-health-check             | 45 15 * * *     |  |
| ⚪ | daily-monetization-review      | 0 18 * * *      |  |
| ⚪ | daily-self-improvement         | 45 6 * * *      |  |
...
| ⚪ | knowledge-freshness-weekly     | 30 9 * * 0      |  |
...
| ⚪ | shai-hulud-weekly-scan         | 0 9 * * 1       |  |
| ⚪ | skill-link-gate                | 15 8 * * 1      |  |
...
| ⚪ | workbuddy-proxy-watchdog       | every 30m       |  |
| ⚪ | 墨题每日代码巡检                       | 45 18 * * *     |  |
| ⚪ | 文献周报                           | 45 7 * * 1      |  |
| ⚪ | 每日仓库+知识库优化                     | 30 22 * * *     |  |
| ⚪ | 每日学习回顾-晚间22点                   | 0 22 * * *      |  |
...
连通率: 67% | 平均延迟: 433ms
  ...
  🟡 siliconflow: HTTP 401 (493ms, reachable)
  🟡 deepseek: HTTP 401 (373ms, reachable)

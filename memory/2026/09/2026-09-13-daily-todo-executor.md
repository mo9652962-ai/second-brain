...
- `knowledge/Research/2026-09-11-self-study/research_moti_ai.md:194` 真实路径 `%USERPROFILE%\...` → 相对路径
- `scripts/assert_state_consistency.py:11` 硬编码 `%USERPROFILE%\...` → `__file__` 相对定位
